...
router.patch("/:id/status", requireRole("OWNER", "ADMIN"), defectController.updateStatus);
router.patch("/:id/assign", requireRole("OWNER", "ADMIN"), defectWorkflowController.assign);
